    ...
    const handleDelete = async (id: string) => {
        if (confirm("estas seguro?")) {
            setTransition(async () => {
                ...
                window.location.href = "/monarch?message=Deleted Succesfully!";
            })
        }
    }
        ...
        <div style={{
            ...
            <div style={{
                ...
                <Link href="/monarch/form">
                    <button style={{ color: "white", backgroundColor: "green", padding: "5px 15px" }}>Add New Monarch +</button>
                </Link>
            </div>
